  ...
  return (
    ...
    >
      <Column classNames="w-full items-center justify-start">
        ...
        >
          <p className="text-xs/6 font-semibold">
          {project.projectType === ProjectType.CourseWork ? "CourseWork" : 
          project.projectType === ProjectType.Personal ? "Personal" :
          project.projectType === ProjectType.TeamProject ? "TeamProject" :
          "Unknown Type"}
          </p>
        </div>
